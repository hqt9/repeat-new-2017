        ...
        if ($this->getRequest()->isPost()) {
            ...
            try {
                ...
                if (count($errors) === 0) {
                    ...
                    $this->_redirectSuccess(Mage::getUrl('*/account', array('_secure'=>true)));
                    return;
                } else {
    ...
    public function getAction()
    {
        ...
        if ($addressId) {
            ...
            if($address->getentityId() > 0){
                $result = ['firstname' => $address->getfirstname(), 'middlename' => $address->getmiddlename(), 'lastname' => $address->getlastname(), 'company' => $address->getcompany(), 'telephone' => $address->gettelephone(), 'fax' => $address->getfax(), 'street[]' => $address->getstreet(), 'city' => $address->getcity(), 'region_id' => $address->getregionId(), 'postcode' => $address->getpostcode(), 'country_id' => $address->getcountryId(), 'url' => Mage::getUrl().'customer/address/formPost/id/'.$address->getentityId()];
